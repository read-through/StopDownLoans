  ...
  it("loads required CLOB backend env values", () => {
    assert.deepEqual(
      loadClobBackendConfig({
        ...
        OUTCOME_TOKEN_ADDRESS: "0x0000000000000000000000000000000000000006",
        ...
        CORS_ALLOWED_ORIGINS: "https://stopdown.example,http://127.0.0.1:5173",
      ...
      }),
      {
        ...
        corsAllowedOrigins: ["https://stopdown.example", "http://127.0.0.1:5173"],
